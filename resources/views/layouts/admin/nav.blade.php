                ...
                <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
									...
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-0 me-lg-2">
										...
										<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0" style="">
											...
											<div class="menu-active-bg px-4 px-lg-0">
                                                ...
                                                <div class="row">
                                                    <!--begin:Col-->
                                                    <div class="col-lg-6 mb-6 mt-3 mb-lg-0">

                                                        <!--begin:Menu item-->
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="{{ route('admin.albums.indexView') }}" class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="{{ route('admin.contact.indexView') }}" class="menu-link">
                                                                <span class="menu-title">Online inquiries</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        <!--end:Menu item-->
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="{{ route('admin.blog.indexView') }}" class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="{{ route('admin.download.indexView') }}" class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="{{ route('admin.faq.indexView') }}" class="menu-link">
                                                    ...
                                                    <div class="col-lg-6 mb-6 mt-3 mb-lg-0">
                                                        ...
                                                        <div class="mb-6">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="{{ route('admin.media.indexView') }}" class="menu-link">
							...
							<div class="app-navbar flex-shrink-0">
								...
								<div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
									<!--begin::Menu wrapper-->
									<div class="cursor-pointer symbol symbol-35px symbol-md-30px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
											...
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="d-flex flex-column">
													<div class="fw-bold d-flex align-items-center fs-5">{{auth()->user()->full_name}}
													    {{-- <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{auth()->user()->full_name}}</span> --}}
                                                    </div>
										...
										<div class="menu-item px-5">
											<a href="{{ route('admin-user.viewProfile') }}" class="menu-link px-5">My Profile</a>
										</div>
										<!--end::Menu item-->
                        ...
                        <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                           ...
                           {{-- <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="{{ route('admin.user.indexView', ['status' => 'pending']) }}">
													<span class="menu-bullet">
                                                        <i class="fa fa-clock"></i>
													</span>
                                            <span class="menu-title">Pending ({{ $pending_user_count }})</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="{{ route('admin.user.indexView', ['status' => 'approved']) }}">
													<span class="menu-bullet">
														<i class="fas fa-check-circle"></i>
													</span>
                                            <span class="menu-title">Complete ({{ $approved_user_count }})</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="{{ route('admin.user.indexView', ['status' => 'beneficiary']) }}">
													<span class="menu-bullet">
														<i class="fas fa-user-circle"></i>
													</span>
                                            <span class="menu-title">Beneficiaries  ({{ $beneficiaries_user_count }})</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="{{ route('admin.user.indexView', ['status' => 'funding_organisation']) }}">
													<span class="menu-bullet">
														<i class="fas fa-bank"></i>
													</span>
                                            <span class="menu-title">Funding organisations ({{ $funding_organisation_user_count }})</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="{{ route('admin.user.indexView', ['status' => 'pharmaceutical_company']) }}">
													<span class="menu-bullet">
														<i class="fas fa-user-md"></i>
													</span>
                                            <span class="menu-title">Pharmaceutical companies ({{ $pharmaceutical_company_user_count }})</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link" href="{{ route('admin.user.indexView', ['status' => 'volunteer']) }}">
													<span class="menu-bullet">
														<i class="fas fa-user"></i>
													</span>
                                            <span class="menu-title">Volunteers ({{ $volunteer_user_count }})</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                           ...
                           {{-- <div class="menu-item here">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ request()->is('admin/categories*') ? 'active' : '' }}" href="{{route('admin.categories.indexView')}}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                         ...
                         {{--   <div class="menu-item here">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ request()->is('admin/request-item*') ? 'active' : '' }}" href="{{route('admin.requests.indexView')}}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                                <i class="fas fa-bars"></i>
                                                <!--end::Svg Icon-->
                            ...
                            <div class="menu-item here">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ request()->is('admin/sliders*') ? 'active' : '' }}" href="{{route('admin.slider.indexView')}}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                         ...
                         <div class="menu-item here">
                            ...
                            <div class="menu-item here">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ request()->is('admin/teams*') ? 'active' : '' }}" href="{{ route('admin.cms.teams.indexView') }}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            ...
                            <div class="menu-item here">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ request()->is('admin/pages*') ? 'active' : '' }}" href="{{route('admin.cms.page.indexView')}}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            ...
                            <div class="menu-item here">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ request()->is('admin/menu*') ? 'active' : '' }}" href="{{ route('admin.menu.indexView') }}">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <i class="fas fa-bars"></i>
                                        <!--end::Svg Icon-->
                            ...
                            <div class="menu-item here">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ request()->is('admin/site*') ? 'active' : '' }}" href="{{route('admin.site-setting.indexView')}}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                           ...
                           {{-- <div class="menu-item here">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ request()->is('admin/email-templates*') ? 'active' : '' }}" href="{{route('admin.email-template-role.indexView')}}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            ...
                            <div class="menu-item here">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ request()->is('admin/admin-user*') ? 'active' : '' }}" href="{{ route('admin-user.indexView', ['user_type' => 'admin']) }}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                                <i class="fas fa-users"></i>
                                                <!--end::Svg Icon-->
                           ...
                           {{-- <div class="menu-item here">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ request()->is('admin/testimonials*') ? 'active' : '' }}" href="{{route('admin.cms.testimonials.indexView')}}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                           ...
                           {{-- <div class="menu-item here">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ request()->is('admin/medias*') ? 'active' : '' }}" href="{{ route('admin.media.indexView') }}">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                           ...
                           {{-- <div class="menu-item here">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ request()->is('admin/album*') ? 'active' : '' }}" href="{{ route('admin.albums.indexView') }}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                           ...
                           {{-- <div class="menu-item here">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ request()->is('admin/notices*') ? 'active' : '' }}" href="{{ route('admin.cms.notices.indexView') }}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                           ...
                           {{-- <div class="menu-item here">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ request()->is('admin/download*') ? 'active' : '' }}" href="{{ route('admin.download.indexView') }}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                           ...
                           {{-- <div class="menu-item here">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ request()->is('admin/transaction-headings*') ? 'active' : '' }}" href="{{ route('admin.transaction-heading.indexView') }}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                                <i class="fas fa-heading"></i>
                                                <!--end::Svg Icon-->
											</span>
                                    <span class="menu-title">Transaction heading </span>
                                </a>
                                <!--end:Menu link-->
                            </div> --}}
                            <!--end:Menu item-->
                           {{-- <div class="menu-item here">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ request()->is('admin/transactions*') ? 'active' : '' }}" href="{{ route('admin.transaction.indexView') }}">
											<span class="menu-icon">
												<!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
