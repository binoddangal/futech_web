...
<head>
    ...
    <style type="text/css">
        ...
        ***********/
        ...
        body{width:100% !important; -webkit-text-size-adjust:100%; -ms-text-size-adjust:100%; margin:0; padding:0; font-family: sans-serif; line-height: 1.5;}
        /* Prevent Webkit and Windows Mobile platforms from changing default font sizes, while not breaking desktop design. */
        .ExternalClass {width:100%;} /* Force Hotmail to display emails at full width */
        .ExternalClass, .ExternalClass p, .ExternalClass span, .ExternalClass font, .ExternalClass td, .ExternalClass div {line-height: 100%;} /* Force Hotmail to display normal line spacing. */
        @if(isset($webview) && $webview)
        #backgroundTable {margin:0 auto; padding:0; width:100% !important; line-height: 150% !important;}
        @else
        #backgroundTable {margin:0 auto; padding:0; width:70% !important; line-height: 150% !important;}
        @endif
        /* End reset */
...
<table cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
    <tr>
        <td style="padding: 25px 0; background-color: #F5F5F5">
            ...
            <table cellpadding="0" cellspacing="0" border="0" align="center" class="container">
                <tr>
                    ...
                    <td width="15%" valign="middle">
                        {{--                        <a href="{{url('what-is-score')}}" class="menu-link" style="color: #ffffff">About Score</a>--}}
                    </td>
                    <td width="10%" valign="middle">
                        {{--                        <a href="{{url('whats-new')}}" class="menu-link"  style="color: #ffffff">What's New</a>--}}
                    </td>
                    <td width="10%" valign="middle">
                        {{--                        <a href="{{ getSiteSetting()->website }}" class="menu-link" style="color: #ffffff">Shop</a>--}}
                    </td>
                </tr>
            </table>
