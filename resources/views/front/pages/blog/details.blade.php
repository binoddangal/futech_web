            ...
            <div class="mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div>
                    <div class="pb-5 border-b border-b-interface-200">
                        <div class="relative">
                            @if ($blog->image_path)
                                <img src="{{ $blog->image_path['real'] }}" class="rounded-lg w-full" alt />
                            @else
                        ...
                        <div class="flex flex-col md:flex-row justify-between mt-10">
                            <div>
                                ...
                                <span>{{ $blog->publish_date ? formatDate($blog->publish_date) : '' }}</span>
                            </div>
                            ...
                            <div class="space-y-7">
                                @foreach ($blogs as $blog)
                                    <article class="flex space-x-4">
                                        ...
                                        <a href="{{ route('blog.detail', ['slug' => $blog->slug]) }}" class="block">
                                            @if ($blog->image_path)
                                                <img src="{{ $blog->image_path['real'] }}" class="rounded w-20" alt />
                                            @else
                                                <img src="{{ asset('assets/images/logo/Futech_Logo.png') }}"
                                                    class="rounded w-20" alt />
                                            @endif
                                        </a>
                                        <div>
                                            ...
                                            <span class="flex space-x-3">
                                                ...
                                                <span class="text-pcolor-500 text-base">
                                                    {{ $blog->publish_date ? formatDate($blog->publish_date) : '' }}</span>
                                            </span>
                                        </div>
                                    </article>
                                @endforeach
