            ...
            <div class="md:col-span-3 lg:col-span-3 pt-8 lg:pt-0 lg:pl-12">
                ...
                <nav>
                    <ul class="space-y-4">
                        ...
                        <li>
                            <a href="{{ route('contact') }}"
                                class="font-medium text-base text-white transition hover:text-porange-700">Privacy
                                policy</a>
                        </li>
                        <li>
                            <a href="{{ route('contact') }}"
                                class="font-medium text-base text-white transition hover:text-porange-700">Terms &
                                conditions
                            </a>
                        </li>
                    </ul>
                ...
                <ul class="space-y-3">
                    @if (getSetting() && getSetting()->address)
                        <li class="flex space-x-2">
                            ...
                            <p class="text-white">{!! getSetting()->address !!}</p>
                        </li>
                    @endif
                    @if (getSetting() && getSetting()->phone)
                        <li class="flex space-x-2">
                            ...
                            <a href="tel:1-888-452-1505" class="text-white text-base">{!! getSetting()->phone !!}</a>
                        </li>
                    @endif
                </ul>
                <div class="mt-7">
